...
The data for this project can be found <a href="https://github.com/icfaust/IPPIoT">on my github</a>, under three separate directories for the various components.  A part list describes what I used initially to build the device. If you have any questions, please do not hesitate!